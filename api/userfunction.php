...
// Connect to DB
    ...
    {
        $sql = "UPDATE orderform SET sumtotalprice = (SELECT SUM(totalprice) FROM orderitem  WHERE orderID = (SELECT max(orderID) orderID FROM orderform where CustomerID= :CustomerID ))

...
elseif ($request->cookies->has('PHPSESSID')) {
        ...
        if ($request->query->getAlpha('action') == 'register') {
            ...
            if ($request->request->has('username') and $request->request->has('password')) {
                ...
                if ($res === false) {
                    ...
                    $response->setContent(json_encode($res));
                    $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'login',$request->cookies->get('PHPSESSID'));
                }
            } else {
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'update',$request->cookies->get('PHPSESSID'));
            $res = $session->get('sessionObj')->isLoggedIn();
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'orderdelete',$request->cookies->get('PHPSESSID'));
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'orderfood',$request->cookies->get('PHPSESSID'));
            if (
            ...
            if (
                ...
                $response->setStatusCode(201);
                $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'addfood',$request->cookies->get('PHPSESSID'));
            ...
            if ($res === true) {
                $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'delete food',$request->cookies->get('PHPSESSID'));
                $response->setStatusCode(201);
            } elseif ($res === false) {
                $response->setStatusCode(403);
            } elseif ($res === 0) {
            ...
            if (
                ...
                if ($res === true) {
                    $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'update food',$request->cookies->get('PHPSESSID'));
                    $response->setStatusCode(201);
                } elseif ($res === false) {
                    $response->setStatusCode(403);
                } elseif ($res === 0) {
            ...
            if ($res == false) {
                ...
                if ($res === true) {
                    $response->setStatusCode(201);
                    $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'start order',$request->cookies->get('PHPSESSID'));
                } elseif ($res === false) {
                    $response->setStatusCode(403);
                } elseif ($res === 0) {
                    $response->setStatusCode(500);
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'checkout',$request->cookies->get('PHPSESSID'));
        ...
        elseif ($request->query->getAlpha('action') == 'registeradmin') {
           ...
           if ($request->request->has('username') and $request->request->has('password')) {
               ...
               if ($res === false) {
                   ...
                   $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'admin login',$request->cookies->get('PHPSESSID'));
                   $response->setStatusCode(200);
                   $response->setContent(json_encode($res));
               }
           } else {
               ...
               if ($res) {
                   ...
                   if (
                    ...
                    $password=$session->get('sessionObj')->input_testing($request->request->get('password'));
                       ...
                       if ($res === true) {
                           $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'edit profile',$request->cookies->get('PHPSESSID'));
                           $response->setStatusCode(201);
                       } elseif ($res === false) {
                           $response->setStatusCode(403);
                       } elseif ($res === 0) {
            ...
            $response->setStatusCode(200);
                ...
                if ($res == false) {
                    ...
                    if (
                        ...
                        if ($res === true) {
                            $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'adduser',$request->cookies->get('PHPSESSID'));
                            $response->setStatusCode(201);
                        } elseif ($res === false) {
                            $response->setStatusCode(403);
                        } elseif ($res === 0) {
                ...
                if ($res === false) {
                    ...
                    if ($res === true) {
                        $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'delete user',$request->cookies->get('PHPSESSID'));
                        $response->setStatusCode(201);
                    } elseif ($res === false) {
                        $response->setStatusCode(403);
                    } elseif ($res === 0) {
                ...
                if ($res === false) {
                    ...
                    if (
                        ...
                        if ($res === true) {
                            $response->setStatusCode(201);
                            $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'update user',$request->cookies->get('PHPSESSID'));
                        } elseif ($res === false) {
                            $response->setStatusCode(403);
                        } elseif ($res === 0) {
                            $response->setStatusCode(500);
    ...
    if ($request->getMethod() == 'GET') {     
        if ($request->query->getAlpha('action') == 'accountexists') {
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'logout',$request->cookies->get('PHPSESSID'));
        ...
        elseif ($request->query->getAlpha('action') == 'adminlogout') {
            ...
            $res =$session->get('sessionObj')->adminlogEvent($this->container->get('request')->getClientIp(),'logout',$request->cookies->get('PHPSESSID'));
            $session->get('sessionObj')->logout();
            $response->setStatusCode(200);
        ...
        elseif ($request->query->getAlpha('action') == 'orderID') {
            ...
            $res =$session->get('sessionObj')->logEvent($this->container->get('request')->getClientIp(),'complete order',$request->cookies->get('PHPSESSID'));
